...
Estime = EstimacaoNaoLinear(WLS,Modelo,simbolos_x=['x1','x2'],simbolos_y=['y1','y2'],simbolos_param=[r'a%d'%i for i in xrange(4)],label_latex_param=[r'$\alpha_{%d}$'%i for i in xrange(4)],unidades_y=['kg','kg'])
...
# Otimização
Estime.otimiza(sup=sup,inf=inf,algoritmo='PSO',itmax=10,Num_particulas=10,metodo={'busca':'Otimo','algoritmo':'PSO','inercia':'TVIW-linear'})
